  ...
  return knex('dreams').del()
    .then(function () {
      return knex('dreams').insert([
        {
          id: 1, dream_date: '5-29-17', emotion: 'fear', lucidity: 1, nightmare: false, recurring: false, user_username: 1,
        ...
        {
          id: 2, dream_date: '6-1-17', emotion: 'happy', lucidity: 1, nightmare: false, recurring: false, user_username: 2,
        ...
        {
          id: 3, dream_date: '6-2-17', emotion: 'frustrated', lucidity: 1, nightmare: false, recurring: false, user_username: 3,
        ...
        {
          id:4, dream_date: '6-2-17', emotion: 'happy', lucidity: 3, nightmare: false, recurring: false, user_username: 4,
